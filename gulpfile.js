...
function gallery_js() {
    return gulp.src('src/assets/js/gallery.js')
        .pipe(include()).on('error', console.log)
...
function scroll_js() {
  return gulp.src('src/assets/js/scroll.js')
      .pipe(include()).on('error', console.log)
      .pipe(concat('scroll.min.js'))
      /*
      .pipe(gulpIf(isProd, uglify({
        keep_fnames: true,
        mangle: false,
...
function watchFiles() {
    ...
    gulp.watch('src/assets/js/**/*.js', gulp.series(gallery_js, browserSyncReload));
    gulp.watch('src/assets/js/**/*.js', gulp.series(plugins_js, browserSyncReload));
    gulp.watch('src/assets/js/**/*.js', gulp.series(scroll_js, browserSyncReload));
...
exports.forms_js = gallery_js;
exports.jquery_js = jquery_js;
exports.scroll_js = scroll_js;
...
exports.del = del;
exports.serve = gulp.parallel(html, ie_css, icon_css, app_css, rtl_css, plugins_css, jquery_js, forms_js, gallery_js,  app_js, scroll_js, plugins_js, modernizr_js, fonts, actions, img, uploads, img_webp, uploads_webp, video, watchFiles, serve);
exports.default = gulp.series(del, html, ie_css, icon_css, app_css, rtl_css, plugins_css, jquery_js, forms_js, gallery_js, app_js, scroll_js, plugins_js, modernizr_js, fonts, actions, img, uploads, img_webp, uploads_webp, video);